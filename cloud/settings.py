...
SECRET_KEY = 'ne-f85+$xx1(%m)8l1tig$x&rx&i&(+%uq-8&%&js1e#6$wuik'
   ...
   #         os.path.join(BASE_DIR, 'templates'), for the static/template to link with the page
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.media', # help to access/process the medial url
            ],
        },
    },
]
...
#setting media url to media directory
